...
<head>
    ...
    <title>合并预订单创建(BPAYPY4152)</title>
</head>
...
//开始打印
        ...
        out.println("响应日期：" + client.changeNull(client.getHead("RspDate")) + "<br>");
        out.println("响应时间：" + client.changeNull(client.getHead("RspTime")) + "<br>");
        out.println("**********交易交付(BPAYPY4152)开始打印**********" + "<br>");
        out.println("一级商户协议号：" + client.changeNull(client.getData("MerPtcId")) + "<br>");
        out.println("商户流水号：" + client.changeNull(client.getData("MerTranSerialNo")) + "<br>");
        ...
        out.println("**********交易交付(BPAYPY4152)结束打印**********" + "<br>");
//结束打印
        out.println("succeed!");
    }
%>
